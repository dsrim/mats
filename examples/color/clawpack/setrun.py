...
#------------------------------
    ...
    probdata.add_param('mu1',       0.6, 'fast amplitude')    # [0.1,0.5]
    probdata.add_param('mu2', 8.0*np.pi, 'fast osc')          # [4.0,6.0]
    probdata.add_param('mu3', 1.0*np.pi, 'slow osc')          # [3pi ,10.0]
    probdata.add_param('mu4',      0.05, 'IC width')          # [0.1,0.5]
    ...
    if clawdata.output_style==1:
        ...
        clawdata.output_times = np.hstack((np.arange(0.0,0.1,0.02),np.arange(0.1,1.1,0.1))) 
