...
#------------------------------
    ...
    probdata.add_param('mu1', 100.00, 'reaction coefficient')
    probdata.add_param('mu2', 0.32, 'transition width')
    ...
    if clawdata.output_style==1:
        ...
        clawdata.tfinal = 3.50
        #clawdata.tfinal = 1.7695312500000113
        #clawdata.tfinal =  1.315429687499994
        clawdata.output_t0 = True  # output at initial (or restart) time?
        
    elif clawdata.output_style == 2:
        # Specify a list or numpy array of output times:
        # Include t0 if you want output at the initial time.
        clawdata.output_times = np.hstack((np.arange(0.0,0.05,0.01),np.arange(0.05,3.5,0.25)))
